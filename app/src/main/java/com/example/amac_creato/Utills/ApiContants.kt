...
public class ApiContants {
    companion object {
        ...
        const val BaseUrl="https://store.amaccreato.com/api/"//Live URL
        ...
        const val getCustomerOrderDetail = "get-customer-order-details"
        const val getCustomerOrders = "get-customer-orders"
        const val getBarcode = "get-barcode"
        const val getBarcodePacker = "get-barcode-packer"
        const val getBarcodeBoxes = "barcode-boxes"
        const val getDashboard = "dashboard"
        const val getCreateBox = "create-box"
        const val GetCustomer = "get-customers"
        const val GetSlotPacker = "get-slots-packer"
        const val GetSlotPackerDetail = "get-slots-packer-details"
        const val GetBoxes = "get-boxes"
        const val GetBoxesDetail = "get-boxes-details"
        const val GetCustOrderDisptch = "get-customer-orders-dispatcher"
