...
class ProductionProdDisBoxAdapter(
    var context: Activity,
    var mFilteredList: List<BoxDetailBean.Data.ProductionProduct>,
    var rvClickListner: RvListClickListner
) : RecyclerView.Adapter<ProductionProdDisBoxAdapter.MyViewHolder>()
    {
