...
class BoxesListAdapter(
...
) : RecyclerView.Adapter<BoxesListAdapter.MyViewHolder>() {

    inner class MyViewHolder(val binding: ItemAllBoxesBinding) :
    ...
    override fun onCreateViewHolder(
        ...
        val binding =
            ItemAllBoxesBinding.inflate(LayoutInflater.from(parent.context), parent, false)
