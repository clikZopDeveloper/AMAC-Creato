...
class HardwareProdListAdapter(
    var context: Activity,
    var mFilteredList: List<SlotPackerDetailBean.Data.HardwareProduct>,
    var rvClickListner: RvListClickListner
) : RecyclerView.Adapter<HardwareProdListAdapter.MyViewHolder>(){
