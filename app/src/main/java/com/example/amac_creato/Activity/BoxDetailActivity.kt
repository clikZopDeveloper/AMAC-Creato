...
import com.example.amac_creato.Adapter.HardwareBoxProdAdapter
import com.example.amac_creato.Adapter.HardwareProdListAdapter
import com.example.amac_creato.Adapter.ProductionProdBoxAdapter
...
class BoxDetailActivity : AppCompatActivity(), ApiResponseListner,
    GoogleApiClient.OnConnectionFailedListener,
    ConnectivityListener.ConnectivityReceiverListener {
    private lateinit var binding: ActivityBoxDetailBinding
    private lateinit var apiClient: ApiController
    lateinit var mAdapterHardware: HardwareBoxProdAdapter
    lateinit var mAdapterProduction: ProductionProdBoxAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.igToolbar.tvTitle.text = "Box Detail"
    ...
    fun handleHardwareList(
        ...
        mAdapterHardware = HardwareBoxProdAdapter(this, data, object :
            RvListClickListner {
    ...
    fun handleProductList(
        ...
        mAdapterProduction = ProductionProdBoxAdapter(this, data, object :
            RvListClickListner {
            override fun clickPos(status: MutableList<Any?>?, id: Int) {
